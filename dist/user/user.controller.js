...
const findByEmail_dto_1 = require("./dto/findByEmail.dto");
...
let UserController = class UserController {
    ...
    async findByEmail(findByEmailDto, user) {
        try {
            ...
            throw new common_1.HttpException({ status: common_1.HttpStatus.BAD_REQUEST, message: error }, common_1.HttpStatus.BAD_REQUEST);
        }
    }
    async getAll() {
        try {
...
__decorate([
    ...
    (0, common_1.UseInterceptors)(new user_interceptor_1.ExcludeFieldUser()),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, getUser_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [findByEmail_dto_1.FindByEmailDto,
        user_entity_1.User]),
